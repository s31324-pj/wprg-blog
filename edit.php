...
<form method="post">
    ...
    <input type="text" name="slug" value="<?php echo htmlspecialchars($post['slug']); ?>" placeholder="Slug (optional)"><br>
    <textarea id="content-editor" name="content"><?php echo htmlspecialchars($post['content']); ?></textarea><br>
    <textarea name="excerpt" placeholder="Excerpt (optional)"><?php echo htmlspecialchars($post['excerpt']); ?></textarea><br>
